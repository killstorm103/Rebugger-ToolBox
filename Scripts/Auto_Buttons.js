 ...
 * Skips the button for the page the user is currently on.
 */

(function() {

    // ========== HELPER: safe trim (no String.prototype.trim) ==========
    ...
    // ========== INSERT INTO PAGE ==========
    // Find the nav-container div inside fixed-header
    ...
    // Replace contents – create the nav bar and margin control together
    var navBarHTML = '<div style="background:#222; border-left:5px solid #dc3545; padding:15px; color:#fff; margin-bottom:0px;">'
                   + buttonsHTML
                   + '</div>';
    ...
    // Add margin control after the nav-container (before the closing of fixed-header)
    // We need to create a new div and insert it right after navContainer
